package com.example.recordapplication.ViewRecordFiles.ShowFullDetailsFiles;
        ...
        themeCakeStatus.setEndIconOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(status.equals("False") || status.equals("false")) {
                    ...
                    themeCakeDescription.setVisibility(View.INVISIBLE);
                } else if(status.equals("True") || status.equals("true")){
                    success = databaseHelperObj.updateThemeCakeStatus(orderId, 1);
                    themeCakeDescription.setVisibility(View.VISIBLE);
                } else {
                    Toast.makeText(ShowFullDetails.this, "Not a Valid Answer, (Valid: True or False)", Toast.LENGTH_SHORT).show();
                }

                if(success == true && (status.equals("True") || status.equals("true"))) {
                    if(themeCakeDescription.getEditText().getText().toString().trim().equals("")) {
                        Toast.makeText(ShowFullDetails.this, "Please Enter The Theme Cake Description!", Toast.LENGTH_SHORT).show();
                    }
                } else if(success == true && (status.equals("False") || status.equals("false"))){
